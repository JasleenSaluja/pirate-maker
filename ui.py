...
class UI:
    def __init__(self,surface):
        ...
        self.font=pygame.font.SysFont('bruno ace',30)
    ...
    def show_coins(self,amount):
        ...
        coin_amount_rect=coin_amount_surf.get_rect(midleft=(self.coin_display_rect.right + 4,self.coin_display_rect.centery))
